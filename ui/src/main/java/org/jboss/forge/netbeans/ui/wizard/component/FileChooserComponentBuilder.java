...
/**
 * Implementation for UIInput<FileResource> components
 *
 * @author <a href="mailto:ggastald@redhat.com">George Gastaldi</a>
 */
@ServiceProvider(position = 80, service = ComponentBuilder.class)
public class FileChooserComponentBuilder extends AbstractTextButtonComponentBuilder {
